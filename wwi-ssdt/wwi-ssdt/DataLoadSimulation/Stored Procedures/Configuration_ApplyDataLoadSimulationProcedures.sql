...
BEGIN
    ...
    DECLARE @TimeToFinishForTheDay datetime2(7) = DATEADD(second, -120, DATEADD(day, 1, @TimeCounter));
...
BEGIN
    ...
    BEGIN
        ...
        SET @CustomFields = JSON_MODIFY(@CustomFields, N''$.HireDate'',
                                        CONVERT(nvarchar(20), DATEADD(day, 0 - CEILING(RAND() * 2000) - 100, ''20100101''), 126));
